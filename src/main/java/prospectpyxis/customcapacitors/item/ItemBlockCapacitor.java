...
public class ItemBlockCapacitor extends ItemBlock {
    ...
    public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> tooltip, ITooltipFlag flagIn) {
        ...
        if (!ModSettings.enableShiftTooltip) {
            ...
            if (!GuiScreen.isShiftKeyDown()) {
                ...
                switch (data.storageLossType) {
                    ...
                    case CONSTANT:
                        ...
                        tooltip.add(I18n.format("tooltip.custom_capacitor.advanced.storage_loss.constant.value",
                    ...
                    case PERCENTAGE:
                        ...
                        tooltip.add(I18n.format("tooltip.custom_capacitor.advanced.storage_loss.percentage.value",
                    ...
                    case PERCENTAGE_INVERTED:
                        ...
                        tooltip.add(I18n.format("tooltip.custom_capacitor.advanced.storage_loss.percentage_inverted.value",
                                TextFormatting.BOLD, TextFormatting.RESET, df.format(data.storageLossData.lossValue * 100)));
                        break;
                }
                ...
                switch (data.inputLossType) {
                    ...
                    case CONSTANT:
                        ...
                        tooltip.add(I18n.format("tooltip.custom_capacitor.advanced.input_loss.constant.value",
                    ...
                    case PERCENTAGE:
                        ...
                        tooltip.add(I18n.format("tooltip.custom_capacitor.advanced.input_loss.percentage.value",
                    ...
                    case PERCENTAGE_INVERTED:
                        ...
                        tooltip.add(I18n.format("tooltip.custom_capacitor.advanced.input_loss.percentage_inverted.value",
                                TextFormatting.BOLD, TextFormatting.RESET, df.format(data.inputLossValue * 100)));
                        break;
                }
            }
